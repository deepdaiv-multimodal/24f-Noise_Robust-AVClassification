...
python -W ignore src/run_cavmae_pl.py --model cav-mae-ft --dataset vggsound --data-train train_relative.json --data-val test_relative.json --exp-dir ./exp_0116 --label-csv class_labels_indices_urban.csv --n_class 10 --lr 1e-3 --n-epochs 50 --batch-size 512 --finetuned_path exp_0116/models/best_audio_model.pth --proportion 0.3 --dataset_mean 0 --dataset_std 1 --target_length 1024 --mode eval --noise_to_audio